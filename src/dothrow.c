        ...
        if (!obj) {
            ...
            if (tethered_weapon) {
                if (!tether_released_msg) {
                    pline(_("The tether comes off your %s."),
                           body_part(ARM));
                ...
                if (!impaired && rn2(100)) {
                    ...
                    if (!dmg) {
                        if (tethered_weapon) {
                            ...
                            pline(_("Your tethered %s snaps back but the tether slips from your %s."),
                        ...
                        dmg += rnd(3);
                        if (tethered_weapon) {
                            Your(_("tethered %s returns and hits your %s!"),
                                 simpleonames(obj), body_part(ARM));
                        } else {
            ...
            if (!breathless(gy.youmonst.data) || haseyes(gy.youmonst.data)) {
                ...
                if (obj->otyp != POT_WATER && !Half_gas_damage) {
                    if (!breathless(gy.youmonst.data)) {
                        ...
                        Your(_("%s %s."), eyes, vtense(eyes, C_("eyes_water", "water")));
                    }
                }
                potionbreathe(obj);
            }
