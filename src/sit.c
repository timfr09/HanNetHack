...
dosit(void)
{
 ...
 in_water:
        ...
        You(_("sit on the %s."), tr_defsym_explanation(S_sink));
        Your(_("%s gets wet."),
             humanoid(gy.youmonst.data) ? _("rump") : _("underside"));
    } else if (IS_ALTAR(typ)) {
        You(_("sit on the %s."), tr_defsym_explanation(S_altar));
        altar_wrath(u.ux, u.uy);
    } else if (IS_GRAVE(typ)) {
        You(_("sit on the %s."), tr_defsym_explanation(S_grave));
    } else if (typ == STAIRS) {
        ...
        You(_("sit on the %s."), tr_defsym_explanation(S_ice));
        if (!Cold_resistance)
            pline_The(_("ice feels cold."));
    } else if (typ == DRAWBRIDGE_DOWN) {
        You(_("sit on the %s."), _("drawbridge"));
    } else if (IS_THRONE(typ)) {
        You(_("sit on the %s."), tr_defsym_explanation(S_throne));
        throne_sit_effect();
