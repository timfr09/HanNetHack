...
그를 물리칠 희망이 있네."]],
      ...
      discourage = {
         ...
         "\"네가 죽으면, 내 무리가 %l{과/와} 네 부족을 끝장내 주마.\"",
...
기다리고 있을 것이다.]],
    ...
    그때 무엇을 해야 하는지 말해주겠네. 때가 되면 이해하게 될 거야.]],
      ...
      offeredit2 = {
         ...
         output = "text",
         text = [[%l{이/가} %o{을/를} 경건하게 바라보다가 다시 자네를 본다.
...
그 말과 함께 %n{이/가} 죽는다.]],
      ...
      leader_first = {
         synopsis = "[%l{은/는} %n{과/와}의 싸움으로 약해졌다. 그가 너를 검사하고 싶어한다.]",
         output = "text",
...
큰 전투가 벌어졌도다. 우리가 사악한 %n{과/와} 싸울 때
...
%o에서 눈을 떼며 말한다:
    ...
    %d와(과) 함께, 옌더의 아뮬렛을 되찾을 수 있을 것이다."]],
      ...
      offeredit2 = {
         synopsis = "[%o{을/를} 가지고 포털을 통해 %Z{으로/로} 돌아가라.]",
         output = "text",
         text = [["%o{은/는} 이제 네 것이다. %Z{이/가}
너를 이곳으로 데려온 마법의 포털 너머에서 네 귀환을 기다리고 있다."]],
      },
      othertime = {
         text = [[%H에 돌아왔다.
...
"얼마 전, %n{과/와} 그의 부하들이 이곳을 공격했다. 그들은
...
%Ra{이/가} 되어 돌아왔을 때만 %n{을/를} 물리칠 수 있을 것이다."]],
      ...
      encourage = {
         ...
         "\"마법 냉기는 %n에게 매우 효과적이다.\"",
         "\"%n{과/와} 맞서려면 화염에 면역이어야 한다.\"",
         "\"%d께서 네 검팔에 힘을 주시길.\"",
         "\"%d{을/를} 믿어라. 널 버리지 않으실 것이다.\"",
         "\"매 순간 라그나로크가 다가오고 있다. 서둘러야 한다, %p.\"",
         "\"%n{이/가} %o{을/를} 마스터하면, 운명보다 훨씬 일찍 %d{과/와} 맞설 만큼 강해질 것이다. 이래서는 안 된다!\"",
         "\"훈련을 기억해라, %p. 넌 할 수 있다.\"",
      },
      firsttime = {
...
돌려줘야 한다는 것을 안다.]],
      ...
      guardtalk_before = {
         ...
         "\"아, 마법 포털 생성 주문이 효과가 있었군요. 대단합니다!\"",
         "\"서둘러요! %l{이/가} 포털 유지 주문을 버티지 못할 수도 있어요!\"",
...
활짝 웃으며 말한다:
    ...
    "%d께서 네 탐색을 인도하시고, 해로부터 지켜주시길."]],
      ...
      offeredit2 = {
         synopsis = "[%o{을/를} 가지고, 포털을 통해 %Z{으로/로} 돌아가서 다른 아뮬렛을 찾아라.]",
         output = "text",
